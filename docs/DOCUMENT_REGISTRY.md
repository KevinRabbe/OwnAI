...
| Document | Version | Status | Purpose | Notes |
|---|---:|---|---|---|
| `docs/DOCUMENT_REGISTRY.md` | 2.6 | active | Central index of docs, status, and cleanup decisions | This file. Must be updated whenever new architecture/roadmap docs are added. |
...
| `docs/SANDBOX_TRUST_GRADUATION_MODEL.md` | 1.0 | active | Defines sandbox depth, trust levels, identity passports, quarantine records, and evidence-based trust graduation | Unknown objects graduate through scoped evidence, not direct trust. |
...
SOURCE_CODE_REFERENCE_LIBRARY.md
